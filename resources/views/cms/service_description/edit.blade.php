            ...
            <form>
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="name" value="{{ $service_descriptions->name }}"
                            name="name" placeholder="أدخل اسم الخدمة">
                    </div>
                    <div class="form-group">
                        <label for="description">الوصف</label>
                        <textarea type="text" class="form-control" id="description" value="{{ $service_descriptions->description }}"
                            name="description" placeholder="أدخل الوصف"></textarea>
                    </div>
                </div>
                <!-- /.card-body -->

                <div class="card-footer">
                    <button type="button" onclick="performUpdate({{ $service_descriptions->id }})"
